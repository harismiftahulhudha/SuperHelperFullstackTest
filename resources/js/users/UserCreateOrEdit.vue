                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group" style="padding-left: 20px;">
                                        <input type="checkbox" class="form-check-input" id="inputIsAdmin" v-model="model.level">
                                        <label class="form-check-label" for="inputIsAdmin">Administrator</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="inputPassword" type="password" class="form-control" v-model="model.password" :required="id === undefined">
                                    </div>
                                    <div class="form-group" v-if="id === undefined">
        ...
        methods: {
            getData() {
                ...
                axios.get('/api/users/' + this.id, {headers})
                    .then((res) => {
                        ...
                        if (parseInt(this.model.level) === 1) {
                            this.model.level = true
                        } else {
                            this.model.level = false
                        }
                        this.getCountries()
                        this.getCities()
                    })
            ...
            storeData() {
                ...
                axios.post(url, formData, {headers})
                    .then((res) => {
                        if (this.id !== undefined) {
                            toastr.success('Successfully edited user', process.env.MIX_APP_NAME)
                        } else {
                            toastr.success('Successfully created user', process.env.MIX_APP_NAME)
                        }
                        loader.hide()
                        this.$router.go(-1)
                    })
